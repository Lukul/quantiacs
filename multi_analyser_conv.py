...
if __name__ == '__main__':
	...
	if makenew:
		...
		conv1 = keras.layers.Conv1D(filters=32, kernel_size=8, strides=4, padding="same")(input_layer)
		conv1 = keras.layers.BatchNormalization()(conv1)
		conv1 = keras.layers.ReLU()(conv1)

		conv2 = keras.layers.Conv1D(filters=64, kernel_size=4, strides=2, padding="same")(conv1)
		conv2 = keras.layers.BatchNormalization()(conv2)
		conv2 = keras.layers.ReLU()(conv2)

		conv3 = keras.layers.Conv1D(filters=64, kernel_size=3, strides=1, padding="same")(conv2)
